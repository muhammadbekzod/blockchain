...
const style = {
  ...
  wrapper: `bg-slate-700 w-screen px-[1.1rem] py-[0.8rem] flex shadow-[0_35px_60px_-2px_rgba(0,0,0,0.2)]`,
  logoContainer: `flex mr-[10rem] items-center cursor-pointer`,
  logoText: ` ml-[0.8rem] text-[white] font-bold text-2xl`,
  searchBar: `flex flex-1 mx-[0.8rem] w-max-[600px] items-center bg-[#fffff] rounded-[0.6rem] border-solid border-2 `,
  searchIcon: `text-[#8a939b] mx-3 font-bold text-lg`,
  searchInput: `h-[2.6rem] w-full border-0 bg-transparent outline-0  ring-0 px-2 pl-0 text-[white] placeholder:text-[#8a939b]`,
  ...
  headerIcon: `text-white text-3xl font-black px-4 hover:text-black cursor-pointer`,
              ...
              <div>
                <Link to='/expore'>
                  <div className={style.headerItem}>
                    <div className="text-white hover:text-black">Explore</div>
                  </div>
                </Link>
              </div>
